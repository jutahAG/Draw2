...
public class Tree extends LandscapeObject{
	...
	private void drawBranches() {
		...
		int[] xpoints = {currentX, currentY, (int) (currentX + trunkWidth/2 - branchWidth/2)};
		int[] ypoints = {currentX, currentY, (int) (currentY + trunkHeight/2 - trunkHeight/2)};
