...
public class DrawPanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		//Populate the scene with your own trees here! PERSONAL TREES
		
		Tree t4 = new Tree(g2, 100, 525, 1, 6, BROWN , DARK_GREEN, "SQUAT");
		t4.draw();
		
		Tree t5 = new Tree(g2, 220, 500, 1, 4, BROWN , GRAY, "SKINNY");
		t5.draw();
		
		Tree t6 = new Tree(g2, 350, 575, 1, 5, BROWN , FOREST_GREEN,"NORMAL");
		t6.draw();
		
		Tree t7 = new Tree(g2, 400, 425, 1, 6, BROWN , DARK_GREEN, "SQUAT");
		t7.draw();
		
		Tree t8 = new Tree(g2, 320, 400, 1, 4, BROWN , GRAY, "SKINNY");
		t8.draw();
		
		Tree t9 = new Tree(g2, 450, 500, 1, 5, BROWN , FOREST_GREEN,"NORMAL");
		t9.draw();
		
		
	}//end of method paintComponent(Graphics) PERSONAL TREES
